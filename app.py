...
st.markdown(
    ...
    "\n**Data sources & notes:** Open Beauty Facts, Open Food Facts, EWG Skin Deep, retailer baselines (2023), company disclosures. This is a prototype — please verify data for high-stakes decisions."
)
